...
class AtisHesaplayiciTest {
    ...
    void belowTableUsesFirstValue() {
        assertEquals(3300.0, AtisHesaplayici.hesaplaHedefRpm(0.8), 1e-9);
    }

    @Test
    @Tag("fast")
    void aboveTableUsesLastValue() {
        assertEquals(4332.0, AtisHesaplayici.hesaplaHedefRpm(6.5), 1e-9);
    }

    @Test
    @Tag("fast")
    void interpolatesBetweenPoints() {
        assertEquals(3890.0, AtisHesaplayici.hesaplaHedefRpm(2.4), 1e-9);
    }
